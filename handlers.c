 ...
 * @name handlers.c
 * 
 * @description A set of functions that handles specific tasks.
 * 
 * @author K P
 * 
 * @date #####
...
// Program shutdown on call and displays an error.
...
// Handles traffic between two-ends
...
// Opens destination socket on a port and returns.
...
// Process function that spawns its copy to handle outbound traffic while parent handles inbounds
...
// Returns a line count of the config file
...
// Parses the config file and returns structure of IP:Port pairs
